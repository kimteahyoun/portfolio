...
const MyInfo = ({ match, history }) => {
  ...
  const onCheckPhonenumberSubmit = (loginuser) => {
  ...
  //validate email
  const onCheckEmailSubmit = (loginuser) => {
  ...
  const onSubmitUpdate = () => {
    ...
    if (onCheckPhonenumberSubmit(loginUser.utel) === false) {
      return;
    }

    if (!onCheckEmailSubmit(loginUser.uemail)) {
      return;
    }
          ...
          <Form style={{ margin: '0px auto' }}>
            <Form.Group className="mb-3" style={{ width: '300px' }}>
              ...
              <Form.Control
                ...
                onChangeLoginUser={onChangeLoginUser} />
            ...
            <Form.Control
              ...
              type="file"
              onChangeLoginUser={onChangeLoginUserFile}
            />
