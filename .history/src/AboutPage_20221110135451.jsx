  ...
  return (
    <div>
      ...
      <div class="my-4" style={{ marginBottom: 140, marginTop: 230 }}>
        <Row>
          <Col >
            <Card style={{ width: '200px', height: "230px", marginLeft: 230, }}>
              <Card.Img style={{height: "230px"}} variant="left" src="/image/a4.png" />
              <Card.Body >
                <Card.Title style={{marignTop:100}}>허재원 - 팀장</Card.Title>
                <Card.Text>
                  총책임자로서 <br/>진두지휘
                </Card.Text>
              </Card.Body>
