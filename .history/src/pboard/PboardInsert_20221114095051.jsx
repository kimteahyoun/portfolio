...
const PboardInsert = ({ history,match }) => {
    ...
    const { pprice, ptitle, pcontent, pimage, file, pwriter } = form;
        ...
        <div>
            ...
            <Row className='d-flex justify-content-center my-5'>
                <Card style={{ width: '60rem' }} className="p-3">
                    <Form>
                        <Grid item xs={12}>
                        <p style={{width:"100%"}}>메인이미지</p>
                        <img src={image || 'https://dummyimage.com/100x100'} alt="빈이미지" title='메인이미지' style={{width:'40%', height:'300',  margintTop:'300'}} />
                    </Grid>
