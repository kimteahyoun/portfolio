  ...
  return (
    <Col style={{ marginTop: 60 }}>
      <Card style={{ width: '30rem', height: 700, padding: 20, margin: '15px 0px' }}>
        ...
        <ButtonGroup>
         {sessionStorage.getItem('uid') && <Button onClick={onClickLike}  variant="primary"><img src={like ? "../image/heart.png" : "../image/emptyheart.png"} width={30}/>{plike}</Button>} 
