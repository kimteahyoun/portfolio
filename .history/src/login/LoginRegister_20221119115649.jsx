...
const LoginRegister = ({ history }) => {
  ...
  const onCheckPasswordSubmit = (form) => {
  ...
  const onCheckPhonenumberSubmit = (form) => {
  ...
  const onRegister = async (e) => {
    ...
    else if (onCheckPasswordSubmit(form.upass) === false) {
      return;
    }

    else if (onCheckPhonenumberSubmit(form.utel) === false) {
      return;
    }

    else if (!onCheckEmailSubmit(form.uemail)) {
      return;
    }
          ...
          <Form>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                autoComplete="upass"
                type="password"
                onChangeForm={(e) => setPass1(e.target.value)}
              />
            </Grid>
