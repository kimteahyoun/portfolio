      ...
      <Card style={{ width: '30rem' }} className="p-3">
        <Form>
          ...
          <div style={{ marginTop: 30 }}>
            <ButtonGroup>
              <Button onClick={onSubmitInsert} style={{ width: '40%', margintTop: 300,marginRight:90 }}>지금 <br/>등록</Button>
              <Button onClick={() => history.push('/my/menu')} style={{ width: '40%', margintTop: 300 }}>나중에<br/> 등록</Button>
            </ButtonGroup>
          </div>
        </Form>
      </Card>
