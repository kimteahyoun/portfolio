...
import { Form, Button, Row, ButtonGroup } from 'react-bootstrap';
          ...
          <Form>
            ...
            <div style={{ marginTop: 30 }}>
              {loginUser.unickname === pwriter &&
                <ButtonGroup>
                  <Button onClick={onSubmit_update} style={{ width: '100%', margintTop: 300 }}>상품 수정</Button>
                  <Button onClick={onSubmit_update} style={{ width: '100%', margintTop: 300 }}>상품 삭제</Button>
                </ButtonGroup>}
            </div>
          </Form>
        </Card>
