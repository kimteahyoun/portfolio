...
{/*내용: div 클래스이름을 지정후 이미지와 
    css 적용해 크기 조절후 p태그 안에 flex 속정을 줘서 컨테이너 하고 아이템을  효과 적용했습니다.*/}
      <div className='vision__statement__wrapper'><p>모두가 나답게 일하고 즐겁게 성장하는 것을 돕는다’는
...
{/*내용: div 클래스이름을 지정후 이미지와 
    css 적용해 크기 조절후 p태그 안에 flex 속정을 줘서 컨테이너 하고 아이템을  효과 적용했습니다.*/}
          <div className='status__list__item'>
            <img src="/image/k1.png" />
            <p>아시아 전역에서 230만 유저와 1만 5천 기업을 300만 번 이상 매칭하고 있습니다.</p>
          </div>
          <div className='status__list__item'  >
            <img src="/image/k2.png" />
            <p>다년간 축적된 300만 건의 지원, 합격 데이터를 기반으로 AI 합격 예측 서비스를 제공합니다.</p>
          </div>
          <div className='status__list__item'>
            <img src="/image/k3.png" />
            <p>매월 1.2억건 이상의 기업·유저 행동 데이터를 실시간으로 축적하고 분석합니다.</p>
          </div>
        </div>
      </div>
      ...
      <iframe width="1100" height="500" 
         src="https://www.youtube-nocookie.com/embed/06Uw0Nyjhh4"
         ...
         {/*내용:이건 당근마켓 페이지 element 이용해 스타일 margin,front사이즈크기를 참고 했습니다*/}
         <div className='c-hUHiUL c-hUHiUL-idPUqJe-css' >
          <h1  className='c-dJYFJr'>지금, 여러분의 동네에서 찾아보세요.</h1>
          <a className='c-kncjfi c-kncjfi-bPZgCp-direction-forward c-bICGYT'
          href='https://team.daangn.com/jobs/' > 중고거래 보러가기</a>
          <svg viewBox='viewBox' className='0 0 34 34' fill='none' xmlns="http://www.w3.org/2000/svg"
          role="img">
        ...
        <p style={{textAlign:'center',marginTop:300 , fontSize:90}}>Project team</p>
        <div class="my-4">
        <Row>
        ...
        <Row style={{marginBottom:500}}>
            <Col>
              <Card style={{ width: '500px', height: "500px",marginTop:220}}>
                <Card.Img variant="left" src="/image/a5.png" />
                <Card.Body>
