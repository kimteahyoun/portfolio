    ...
    <div>
      <Row className='d-flex justify-content-center my-5'>
        <Card style={{ width: '30rem' }} className="p-3">
          ...
          <div className='my-3'>
            <ButtonGroup>
              <Button style={{marginRight:100}} onClick={() => history.push("/login/findid")} variant='secondary'>아이디 찾기</Button>
              <Button onClick={() => history.push('/login/findpass')} variant='secondary' style={{ marginRight: 40 }}>비밀번호 찾기</Button>
            </ButtonGroup>
          </div>
        </Card>
      </Row>
