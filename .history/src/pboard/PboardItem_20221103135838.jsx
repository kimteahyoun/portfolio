    ...
    <Col style={{ marginTop: 60 }}>
      <Card style={{ width: '30rem', height: 700, padding: 20, margin: '15px 0px' }}>
        <Card.Body>
          ...
          <Card.Title style={{textAlign:'left', marginTop:20}}>
           작성자: {pwriter}</Card.Title>
          <hr/>
          <Card.Title style={{textAlign:'left', marginTop:20}}>제목: {ptitle}</Card.Title>
          <hr/>
          <Card.Text style={{textAlign:'center', marginTop:15}}>내용:<hr/> {pcontent}</Card.Text>
        </Card.Body>
        <ButtonGroup>
