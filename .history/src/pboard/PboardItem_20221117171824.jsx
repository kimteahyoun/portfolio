    ...
    <>
      {pcondition === 0 &&
        <Col md="auto" style={{ marginTop: 60 }}>
          ...
          <Card border='success' bg='light' style={{ width: '29rem', height: 700, padding: 10 }}>
            ...
            <ButtonGroup>
              ...
              <Button style={{ marginLeft: 320 }} variant='secondary'>
                <Nav.Link className='box' onClick={onClick} href={`/pboard/read/${pcode}`}>자세히<br/>보기</Nav.Link>
              </Button>
            </ButtonGroup>
