        ...
        <Container>
          ...
          <Nav className="me-auto"
            ...
            <NavDropdown title="상품" id="navbarScrollingDropdown">
              <NavDropdown.Item onClick={onClick} href="/pboard">상품 목록</NavDropdown.Item>
              {sessionStorage.getItem('uid') &&
                <NavDropdown.Item onClick={onClick} href={`/pboard/insert/${loginUser.unickname}`}>상품 등록</NavDropdown.Item>

              }
            </NavDropdown>
            <Nav.Link href={`/event/list`} onClick={onClick}>
              이벤트
            </Nav.Link>
          </Nav>
          <Nav>
            ...
            {sessionStorage.getItem('uid') ?
              <>
                ...
                <Nav.Link href={`/my/review/${loginUser.unickname}`} onClick={onClick}>
                  내 리뷰보기
                </Nav.Link>
