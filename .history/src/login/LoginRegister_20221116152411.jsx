  ...
  const onSubmitRegister = async (e) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        //prompt를 while문안에 집어넣으면 안됨.. 어케해야되누
        const authnum = prompt('인증번호를 입력하세요.');
        
          if (parseInt(authnum) !== (result.data)) {
            console.log(authnum) 
            console.log(result.data)
            console.log(typeof authnum) //string
            console.log(typeof result.data) //number. 따라서 parseInt로 넣어줌. 
            Swal.fire({
