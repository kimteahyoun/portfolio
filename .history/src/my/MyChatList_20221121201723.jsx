...
const MyChatList = ({ location, history }) => {
    ...
    const getRoomList = () => {
        ...
        onSnapshot(q, (snapshot) => {
            ...
            snapshot.forEach((doc) => {
             ...
             const chatRoomList= document.getElementsByClassName('list-group chat-list')[0];
                
             chatRoomList.appendChild(li);

                const chatRoomId=document.getElementsByClassName('list-group-item')[0];
    ...
    const sendMessage = async (e) => {
        if (e.keyCode === 13) {
            ...
            const docRef = doc(db, 'chatroom', `${sessionStorage.getItem('uid')}`);
