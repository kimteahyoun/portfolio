        ...
        <Card style={{ width: '30rem' }} className="p-3">
          <Form>
            ...
            <ButtonGroup>
              ...
              <Button style={{ marginLeft: 60 }} onClick={() => history.push("/login/register")}>회원가입</Button>
            </ButtonGroup>
          </Form>

          <div className='my-3'>
            <ButtonGroup>
              <Button style={{marginRight:80}} onClick={() => history.push("/login/findid")} variant='secondary'>아이디 찾기</Button>
              <Button style={{marginLeft:20}} onClick={() => history.push('/login/findpass')} variant='secondary' style={{ marginRight: 40 }}>비밀번호 찾기</Button>
            </ButtonGroup>
          </div>
        </Card>
      </Row>
