      ...
      <Row className='d-flex justify-content-center my-5'>
        <Card style={{ width: '30rem' }} className="p-3">
          <Form>
            ...
            <Button onClick={onCheckUid} className='mt-3'>중복 확인</Button>
            ...
            <Button onClick={onConfirmPassword} className='mt-3'>일치 확인</Button>
            ...
            <Button className='mt-3' onClick={onCheckUnickanme}>중복확인</Button>
