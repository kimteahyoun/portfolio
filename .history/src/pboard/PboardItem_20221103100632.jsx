          ...
          {sessionStorage.getItem('uid') &&
            <Button onClick={() => onToggleLike(loginUser.unickname, pcode)} variant="primary">
              <img src={
                ...
                loveList ?  "../image/heart.png" : "../image/emptyheart.png"/* "../image/emptyheart.png" */} width={30} />
              {plike}
            </Button>
          }
          <Link to={`/pboard/read/${pcode}`}><Button style={{ marginLeft: 250 }} variant='secondary'>자세히보기</Button></Link>
        </ButtonGroup>
      </Card>
