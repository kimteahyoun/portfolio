    ...
    <div>
      <Row className='d-flex justify-content-center my-5'>
        <Card style={{ width: '30rem' }} className="p-3">
          ...
          <div className='my-3'>
            <ButtonGroup>
            <Link to="/login/register"><Button variant='secondary'style={{marginRight:40}}>회원가입</Button></Link>
            <Link to="/login/findpass"><Button variant='secondary'style={{marginRight:40}}>비밀번호 찾기</Button></Link>
            <Link to="/login/findid"><Button variant='secondary'>아이디 찾기</Button></Link>
            </ButtonGroup>
          </div>
        </Card>
      </Row>
