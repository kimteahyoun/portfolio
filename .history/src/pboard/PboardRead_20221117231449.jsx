...
const PboardRead = ({ match, history }) => {
  ...
  const callPostRead = async () => {
    ...
    try {
      ...
      console.log(typeof result.data.pcondidtion);
      if (result.data !== '' || parseInt(result.data.pcondition)===1) {
          ...
          <Form>
            ...
            <div style={{ marginTop: 30 }}>
              ...
              <ButtonGroup>
                ...
                {loginUser.unickname !== pwriter &&
                <Button style={{ marginRight: 90 }} onClick={() => history.push(`/my/chat/${pcode}`)}>채팅하기</Button>}
